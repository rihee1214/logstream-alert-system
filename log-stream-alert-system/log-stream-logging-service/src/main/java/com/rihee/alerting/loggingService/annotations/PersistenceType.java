 ...
 * 클래스에만 적용되어야 하며, 해당 클래스는 반드시 {@link com.rihee.alerting.loggingService.persistence.LogPersistence}
 * 인터페이스를 구현해야 합니다.
 *
 ...
 * @see com.rihee.alerting.loggingService.persistence.LogPersistence.Builder
