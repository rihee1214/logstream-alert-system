...
public class DefaultLogValidator extends LogValidator {
  ...
  /**
   * {@link DefaultLogValidator}를 생성하기 위한 빌더를 반환합니다.
   *
   * @return {@link DefaultLogValidator} 전용 빌더
   */
  ...
  /**
   * {@link DefaultLogValidator} 인스턴스를 생성하기 위한 빌더입니다.
   *
  ...
  public static class Builder implements LogValidator.Builder<DefaultLogValidator> {
    ...
    /**
     * {@link DefaultLogValidator} 인스턴스를 생성합니다.
     *
     * @return 새 {@link DefaultLogValidator} 인스턴스
     */
    @Override
