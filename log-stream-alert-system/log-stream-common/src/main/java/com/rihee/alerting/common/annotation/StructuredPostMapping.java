 ...
 * }</pre>
 *
 * <p>{@code @PostMapping}, {@code @RequestMapping(method = RequestMethod.POST)}의 사용은 금지되며,</p>
 * <p>모든 POST 요청은 반드시 {@code @StructuredPostMapping}을 통해 정의되어야 합니다. (Checkstyle 정책 적용)</p>
 *
