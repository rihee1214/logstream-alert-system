...
/**
 * {@code @StructuredGetMapping}은 {@link org.springframework.web.bind.annotation.GetMapping}의
 * 대체 어노테이션으로, 구조화된 로깅과 추적을 위해 {@code spanLabel} 속성을 필수로 지정하는 GET 요청 매핑 어노테이션입니다.
 *
 ...
 * }</pre>
 *
 * <p>{@code @GetMapping}, {@code @RequestMapping(method = RequestMethod.GET)}의 사용은 금지되며,
 * 모든 GET 요청은 반드시 {@code @StructuredGetMapping}을 통해 정의되어야 합니다. (Checkstyle 정책 적용)</p>
 *
