 ...
 *
 * <p>
 * HTTP 요청 처리 흐름에 {@link StructuredLogInterceptor}를 등록하여,
 * 로그 트레이싱 및 MDC 컨텍스트 초기화/정리를 전역적으로 적용합니다.
 * </p>
 *
 * <p>
 * 또한 {@link SpanLabelRegistry}, {@link SpanLabelBeanPostProcessor}, {@link StructuredLogInterceptor}
...
public class WebConfig implements WebMvcConfigurer {
     ...
     *
     * <p>
     * 각 컨트롤러 메서드에 선언된 {@code spanLabel} 정보를 등록/조회하기 위한 구조체로,
     ...
     *
     * <p>
     * 애플리케이션 실행 시점에 모든 {@link org.springframework.web.bind.annotation.RequestMapping} 계열 메서드를 탐색하여,
     * {@code spanLabel} 메타정보를 추출하고 {@link SpanLabelRegistry}에 등록합니다.
     * </p>
     *
     * <p>
     * {@link org.springframework.beans.factory.config.BeanPostProcessor} 구현체이므로,
     ...
     *
     * <p>
     * 이 인터셉터는 모든 HTTP 요청 전후에 MDC 값을 설정 및 해제하며,
     ...
     *
     * <p>
     * 이 설정을 통해 StructuredLogInterceptor가 전역적으로 동작하며,
